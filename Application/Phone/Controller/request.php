 ...
 * ================================================================
 */
vendor('pay.Utils.class.php');
vendor('pay.config.php');
vendor('pay.RequestHandler.class.php');
vendor('pay.ClientResponseHandler.class.php');
vendor('pay.PayHttpClient.class.php');
